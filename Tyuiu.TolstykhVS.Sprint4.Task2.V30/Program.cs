...
using Tyuiu.TolstykhVS.Sprint4.Task2.V30.Lib;

namespace Tyuiu.TolstykhVS.Sprint4.Task2.V30
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.Title = "Спринт #4 | Выполнила: Толстых В.С | СМАРТб-23-1";
            ...
            Console.WriteLine("* Выполнила: Толстых В.С | СМАРТб-23-1                                    *");
            Console.WriteLine("***************************************************************************");
